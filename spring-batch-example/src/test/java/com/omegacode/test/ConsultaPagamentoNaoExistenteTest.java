...
public class ConsultaPagamentoNaoExistenteTest {
	
	private Logger log = Logger.getLogger(ConsultaPagamentoNaoExistenteTest.class.getName());
	...
	public void init() {
		...
		numeroCartao = "0000000001";
	}	
	
	@Test
	public void consultarTest() throws Exception {
		
		log.log(Level.INFO ,"INICIANDO O TESTE CONSULTAR PAGAMENTO NAO EXISTENTE!");
		...
		log.log(Level.INFO ,"FIM DO TESTE CONSULTAR PAGAMENTO NAO EXISTENTE!");
	}
